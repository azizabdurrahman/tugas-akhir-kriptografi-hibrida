...
class BruteForceSimulator:
    ...
    def attack(self, suite, bit_length, progress_callback=None):
        ...
        Diasumsikan sebagian besar bit kunci 256-bit telah bocor, sehingga
        Brute Force hanya dilakukan pada N bit terakhir menggunakan bit masking.
        
        progress_callback: fungsi opsional(iterasi, max_keys) untuk update progress GUI.
        """
        ...
        progress_interval = max(1, max_keys // 20)  # update ~20 kali per serangan
        ...
        if cracked:
            ...
            # Menghitung berapa karakter HEX yang dicari (1 karakter hex = 4 bit)
